    ...
    return (
        ...
        <div id="super-stipendium">
            ...
            <article className="stipendium-left">
                ...
                <h4>Der SuperDigital e.V. und das DigiHub, eines der wichtigsten digitalen Matchmaker Düsseldorfs, ermöglichen dir ein <span className="square">Stipendium</span>  in der Landeshauptstadt bei SuperCode und damit die Teilnahme an einem der <span className="line2"><span className="line">zertifizierten</span></span> Vollzeit- oder Teilzeitbootcamps im Bereich Webentwicklung. Bewirb dich jetzt bis zum <span className="circle">10.10.2020</span> und mit etwas Glück erhälst DU ein Stipendium für einen dieser zwei Kurse.
